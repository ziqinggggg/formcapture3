...
class NotesService {
  ...
  Future<DatabaseNote> updateNote({
    ...
    required String text,       // how to say that either title or text is required
  }) async {
    ...
    final updatesCount = await db.update(
      noteTable,
      {
        ...
        modifiedDateColumn: DateTime.now(),
      },
      where: 'id = ?',
      whereArgs: [note.id],
    );
  ...
  Future<DatabaseNote> createNote({required DatabaseUser owner}) async {
    ...
    final noteId = await db.insert(noteTable, {
      ...
      titleColumn: title,
      textColumn: text,
      createdDateColumn: DateTime.now(),
      modifiedDateColumn: DateTime.now(),
...
class DatabaseNote {
  ...
  DatabaseNote.fromRow(Map<String, Object?> map)
      : id = map[idColumn] as int,
        ...
        modifiedDate = map[modifiedDateColumn] as DateTime,
        isSyncedWithCloud =
